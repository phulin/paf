...
Cover the entire source chapter before polishing optional bodies. Run `{build_command}`, fix every
elaboration error, remove scratch files and exploratory commands, and edit only the assigned chapter
scope. Do not commit.
