...
export const demoState: SwarmState = {
  ...
  capability_packages: {
    "package-demo": {
      id: "package-demo",
      capability_key: "discriminant.index-correction",
      title: "Index-corrected discriminant bridge",
      mathematical_objective: "Implement and validate the shared discriminant interface.",
      status: "implementing",
      aliases: [],
      textbook_refs: ["Algebra, Lemma 49.3"],
      write_scope: ["lean/Book03/Chapter08.lean"],
      expansion_scope: ["lean/Book03/**/*.lean"],
      base_revision: "8c02e174",
      plan_revision: 2,
      revision: 7,
      branch: "paf/package-demo",
      worktree: ".paf/worktrees/package-demo",
      created_at: now,
      updated_at: now,
    },
  },
